...
def book_ticket():
   ...
   filename="E:/pythonairlineproject/images/tr1.jpg"
   bgImage = ImageTk.PhotoImage(file=filename)
...
def get_ticket():
   ...
   filename1 = "E:/pythonairlineproject/images/ticket.jpg"
   bgImage = ImageTk.PhotoImage(file=filename1)
   bgLabel = Label(window, image=bgImage)
   bgLabel.place(x=0, y=0)
...
def cancel_flight():
   ...
   filename2="E:/pythonairlineproject/images/cancel1.jpg"
   bgImage = ImageTk.PhotoImage(file=filename2)
   bgLabel = Label(window, image=bgImage)
   bgLabel.place(x=0, y=0)
...
# database part for Login window
        def Login_user():
            if usernameEntry.get() == '' or password.get() == '':
                ...
                if row == None:
                    ...
                    filename4="E:/pythonairlineproject/images/aeroplane4.jpg"
                    bgImage = ImageTk.PhotoImage(file=filename4)
        ...
        def hide():
            openeye.config(file='E:/pythonairlineproject/images/m.png')
            password.config(show='*')
            eyeButton.config(command=show)

        def show():
            openeye.config(file='E:/pythonairlineproject/images/mm.png')
            password.config(show='')
        ...
        p1 = PhotoImage(file="E:/pythonairlineproject/images/login.png")
        LoginPage.iconphoto(False, p1)
        # Placing Image
        filename5="E:/pythonairlineproject/images/login1.jpg"
        bgImage = ImageTk.PhotoImage(file=filename5)
        ...
        # Eye Button
        openeye = PhotoImage(file='E:/pythonairlineproject/images/mm.png')
    ...
    # Adding Image
    bgimg = ImageTk.PhotoImage(file='E:/pythonairlineproject/images/login1.jpg')
...
def insert_flight():
    ...
    window.resizable(False, False)
    window.title('Get ticket')
    bgImage = ImageTk.PhotoImage(file="E:/pythonairlineproject/images/ticket.jpg")
    bgLabel = Label(window, image=bgImage)
    bgLabel.place(x=0, y=0)
...
def delete_flight():
    ...
    bgImage = ImageTk.PhotoImage(file="E:/pythonairlineproject/images/cancel1.jpg")
    bgLabel = Label(window, image=bgImage)
    bgLabel.place(x=0, y=0)
...
def Login():
    ...
    def Login_user():
        ...
        if usernameEntry.get() == '' or password.get() == '':
            ...
            conn = cx_Oracle.connect(user='airline', password='mmmk')
            cur = conn.cursor()
            query ="SELECT * FROM admin WHERE LOWER(username) = LOWER(:1) AND LOWER(password) = LOWER(:2)"

            print(f"Username: {usernameEntry.get()}, Password: {password.get()}")
            ...
            if row == None:
                ...
                bgImage = ImageTk.PhotoImage(file="E:/pythonairlineproject/images/admin4.jpg")
    ...
    # Placing Image
    bgImage = ImageTk.PhotoImage(file="E:/pythonairlineproject/images/Ghostlamp.jpg")
    bgLabel = Label(LoginPage, image=bgImage)
    bgLabel.place(x=0, y=0)
...
air.title("Airlines")
bgImage = ImageTk.PhotoImage(file="E:/pythonairlineproject/images/main.jpg")
